    ...
    const steps = [
        {
            ...
            description: "Tell us what you need—junk removal, cleaning, disinfection, or organizing. We listen carefully and provide a fast, affordable quote tailored to your situation.",
            icon: (
        ...
        },
        {
            ...
            description: "Choose a convenient date and time. Our team prepares everything in advance, including special requests like female staff support or handling difficult items.",
            icon: (
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {
            number: "03",
            title: "Professional Service & Completion",
            description: "Our trained staff arrives on time, works efficiently, and completes the job with care. We ensure your space is clean, organized, and ready—quickly and affordably.",
            icon: (
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <p className="max-w-2xl mx-auto mt-4 text-base text-gray-400 leading-relaxed md:text-lg lg:text-xl">
                        Our professional team ensures a seamless experience from start to finish
                    </p>
                </div>
