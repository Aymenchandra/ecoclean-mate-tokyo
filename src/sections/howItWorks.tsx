                ...
                <div className="relative mt-12 lg:mt-20">
                    ...
                    <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                        <div>
                            ...
                            <h3 className="mt-6 text-xl  text-white font-semibold leading-tight md:mt-10">Contact & Consultation</h3>
                            <p className="mt-4 text-base text-gray-400 md:text-lg">
                                Tell us what you need—junk removal, cleaning, disinfection, or organizing. We listen carefully and provide a fast, affordable quote tailored to your situation.
                            </p>
                        </div>
                        <div>
                            <div
                            ...
                            <h3 className="mt-6 text-xl text-white font-semibold leading-tight md:mt-10">Scheduling & Planning</h3>
                            <p className="mt-4 text-base text-gray-400 md:text-lg">
                                Choose a convenient date and time. Our team prepares everything in advance, including special requests like female staff support or handling difficult items.
                            </p>
                        </div>
                        <div>
                            <div
                            ...
                            <h3 className="mt-6 text-xl text-white font-semibold leading-tight md:mt-10">Professional Service & Completion</h3>
                            <p className="mt-4 text-base text-gray-400 md:text-lg">
                                Our trained staff arrives on time, works efficiently, and completes the job with care. We ensure your space is clean, organized, and ready—quickly and affordably.
                            </p>
                        </div>
                    </div>
                </div>
