                ...
                <div className="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <div className="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
                        ...
                        <p className="mt-6 flex items-baseline gap-x-1">
                            <span className="line-through text-2xl font-sans text-gray-500/70">$39</span><span
                                className="text-5xl font-bold tracking-tight text-gray-900">$29</span>
                        </p>
                        <a href=""
                    ...
                    <div className="ring-2 ring-blue-600 rounded-3xl p-8 xl:p-10">
                        ...
                        <p className="mt-6 flex items-baseline gap-x-1">
                            <span className="line-through text-2xl font-sans text-gray-500/70">$59</span><span
                                className="text-5xl font-bold tracking-tight text-gray-900">$39</span>
                        </p>
                        <a href=""
