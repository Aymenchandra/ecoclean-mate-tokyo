        ...
        <section
            ...
            <div className="flex flex-col items-center md:items-start">
                ...
                <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 text-xs rounded-full px-4 py-1.5 mb-6 hover:bg-orange-100 transition-all duration-300 shadow-sm hover:shadow-md">
                    ...
                    <span className="font-medium">年中無休・迅速対応</span>
                    <svg className="w-4 h-4" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 6.5h14M9.5 1 15 6.5 9.5 12" stroke="currentColor" strokeWidth="1.5"
                ...
                <p className="mt-6 text-gray-600 max-w-md text-sm sm:text-base leading-relaxed">
                    東京、神奈川、埼玉、千葉エリアでの不用品回収、ウイルス消毒、遺品整理・生前整理、
                    ゴミ屋敷清掃に対応いたします。
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center mt-8 gap-4">
                    <button
                        ...
                        type="button">
                        <span>お問い合わせ：03-6885-9300</span>
                        <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.821 11.999h13.43m0 0-6.714-6.715m6.715 6.715-6.715 6.715" stroke="currentColor"
                ...
                <div className="mt-12 flex items-center gap-8 sm:gap-12">
                    <div className="flex flex-col items-center sm:items-start">
                        <span className="text-2xl sm:text-3xl font-bold text-orange-500">100+</span>
                        <span className="text-gray-600 text-sm">月間ご依頼件数</span>
                    </div>
                    <div className="flex flex-col items-center sm:items-start">
                        <span className="text-2xl sm:text-3xl font-bold text-orange-500">365</span>
                        <span className="text-gray-600 text-sm">年中無休</span>
                    </div>
                    <div className="flex flex-col items-center sm:items-start">
                        <div className="flex items-center gap-1">
                            <span className="text-2xl sm:text-3xl font-bold text-orange-500">5</span>
                            <svg className="w-5 h-5 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                            </svg>
                        </div>
                        <span className="text-gray-600 text-sm">お客様評価</span>
                    </div>
                </div>
            </div>

            {/* ヒーロー画像 */}
            <div aria-label="リーダーの写真" className="mt-12 md:mt-0 pb-6">
                <div className="relative">
                    <div className="absolute -inset-4 bg-gradient-to-r from-orange-400 to-orange-600 rounded-2xl blur-xl opacity-20"></div>
                    <img src={heroImg} alt="ヒーロー画像" className="relative w-80 h-96 sm:w-96 sm:h-[440px] md:w-[420px] md:h-[440px] rounded-2xl hover:scale-105 transition duration-500 object-cover shadow-2xl hover:shadow-orange-500/25" />
                </div>
            </div>
        </section>
    );
