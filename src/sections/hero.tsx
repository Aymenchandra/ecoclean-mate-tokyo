        ...
        <section
            ...
            <div className="flex flex-col items-center md:items-start">
                ...
                <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 text-xs rounded-full px-4 py-1.5 mb-6 hover:bg-orange-100 transition-all duration-300 shadow-sm hover:shadow-md">
                    ...
                    <span className="font-medium">Explore how we help grow brands.</span>
                ...
                <p className="mt-6 text-gray-600 max-w-md text-sm sm:text-base leading-relaxed">
                    ...
                    their customer journey with exceptional results.
                </p>
                ...
                <div className="mt-12 flex items-center gap-8 sm:gap-12">
                    ...
                    <div className="flex flex-col items-center sm:items-start">
                        <span className="text-2xl sm:text-3xl font-bold text-orange-500">24h</span>
                        <span className="text-gray-600 text-sm">Farm to Table</span>
                    </div>
                    <div className="flex flex-col items-center sm:items-start">
            ...
            {/* Hero Image */}
            <div aria-label="Photos of leaders" className="mt-12 md:mt-0 pb-6">
                <div className="relative">
                    <div className="absolute -inset-4 bg-gradient-to-r from-orange-400 to-orange-600 rounded-2xl blur-xl opacity-20"></div>
                    <img src={heroImg} alt="heroImg" className="relative w-80 h-96 sm:w-96 sm:h-[440px] md:w-[420px] md:h-[440px] rounded-2xl hover:scale-105 transition duration-500 object-cover shadow-2xl hover:shadow-orange-500/25" />
                </div>
            </div>
        </section>
    );
